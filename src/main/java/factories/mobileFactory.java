...
public class mobileFactory {
    ...
    public AndroidDriver launchMobile(String platformType) throws MalformedURLException {
        ...
        String pathApk = System.getProperty("user.dir") + File.separator + "src/main/resources/build/app.apk";
        ...
        dc.setCapability("appPackage", "com.synrgy.kaboor.dev");
        dc.setCapability("appActivity", "com.synrgy.kaboor.base.SplashActivity");
